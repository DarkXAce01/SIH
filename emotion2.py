...
if average_emotion == emotion_labels[6] and emotion_scores.get(average_emotion) != frame_count:
    print(f"Average Emotion:  {second_max_emotion} (over {emotion_scores.get(second_max_emotion)} frames)")
else:
    print(f"Average Emotion: {average_emotion} (over {emotion_scores.get(average_emotion)} frames)")
